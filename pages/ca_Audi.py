...
#----------------------------------------------------------------
# adding and cleaning the dataframe
...
fig2 = px.bar(df , x = 'Fuel_Tank_Capacity' , y='Power' , )
...
# --------------html layout contains - dashtable , bar chart------------------------
def htmlwork():
    return html.Div([
        html.Div([
        ...
        ],style={'width':'40%' , 'float' : 'left','margin-left' :'3%',}),


        html.Div([
            dcc.Graph(figure = fig1)
        ],style={'width':'50%' , 'float' : 'left' , 'margin-left' :'1%'}),
